...
########################################################
# Global Robustness Sweep for MNIST LeNet-5 (Posit)
# ------------------------------------------------------
# - Compiles posit_bab_verify_lenet5_replay_nolace once
# - Runs idx 0..NUM_IMAGES-1
# - Up to MAX_JOBS in parallel
# - Uses full-image region: --xrc 0-27,0-27
# - Budget: K=2, B=4 (small local budget, global pixel scope)
# - Saves per-idx logs
...
# Output structure
OUTDIR=global_robustness_lenet5
LOGDIR="$OUTDIR/logs"
SUMMARY="$OUTDIR/global_robustness_lenet5.csv"

# Common verifier args (full image, small budgets)
# Equivalent to:
# ./posit_bab_verify_lenet5_replay_nolace \
#   --idx X --xrc 0-27,0-27 --kmax 2 --bmax 4 \
#   --widen 1.0 --verbose 2 --topx 2 --rank-fast \
#   --depth 500000000 --timelimit 5000
...
echo "================================================"
echo " Global Robustness Sweep (LeNet-5)"
echo " Binary:       $BIN"
...
outdir = pathlib.Path("global_robustness_lenet5")
logdir = outdir / "logs"
summary_path = outdir / "global_robustness_lenet5.csv"
...
echo "==============================================="
echo " Global Robustness Sweep (LeNet-5) Complete"
