...
########################################################
# Global Robustness Sweep for MNIST MLP (Posit)
# ------------------------------------------------------
# - Compiles posit_bab_verify_replay once
# - Runs idx 0..NUM_IMAGES-1
# - Up to MAX_JOBS in parallel
# - Uses full-image patch: --xrc 0-27,0-27
# - Budget: K=2, B=4 (small local patch, global search)
# - Saves per-idx logs
...
SRC=posit_bab_verify_replay.c
BIN=./posit_bab_verify_replay
...
# Output structure
OUTDIR=global_robustness_mlp
LOGDIR="$OUTDIR/logs"
SUMMARY="$OUTDIR/global_robustness_mlp.csv"

# Common verifier args (from your example command + depth/timelimit)
# ./posit_bab_verify_replay \
#   --idx 1 --xrc 0-27,0-27 --kmax 2 --bmax 4 \
#   --widen 1.0 --verbose 2 --topx 2 --rank-fast
COMMON_ARGS="--xrc 0-27,0-27 \
             --kmax 2 \
             --bmax 4 \
             --widen 1.0 \
             --verbose 2 \
...
echo "================================================"
echo " Global Robustness Sweep (MLP)"
echo " Binary:       $BIN"
...
outdir = pathlib.Path("global_robustness_mlp")
logdir = outdir / "logs"
summary_path = pathlib.Path("global_robustness_mlp.csv")
...
echo "==============================================="
echo " Global Robustness Sweep Complete"
