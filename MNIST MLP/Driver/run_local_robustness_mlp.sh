...
###############################################
# Local Robustness Sweep for MNIST MLP (Posit)
# ---------------------------------------------
...
# Output structure
OUTDIR=local_robustness_mlp
LOGDIR="$OUTDIR/logs"
SUMMARY="$OUTDIR/local_robustness_mlp.csv"

# Common verifier args (tweak + reuse)
COMMON_ARGS="--roi-heur 2 \
             --topx 2 \
             --kmax 2 \
             --bmax 4 \
             --widen 1.0 \
...
echo "==============================================="
echo " Local Robustness Sweep (MLP)"
echo " Binary:       $BIN"
...
outdir = pathlib.Path("local_robustness_mlp")
logdir = outdir / "logs"
summary_path = outdir / "local_robustness_mlp.csv"
...
echo "==============================================="
echo " Local Robustness Sweep Complete"
